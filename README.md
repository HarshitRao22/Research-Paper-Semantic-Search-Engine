...
The `paper_embeddings.npy` file is not included in this repository because of GitHub's file size limit.

The embeddings can be regenerated by running the notebook from the beginning.
